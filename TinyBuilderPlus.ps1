...
$isoStatusLabel = New-Label "Selected: Windows 11 — opens Microsoft's official page. Use Download ISO to fetch it automatically." 15 535 515
...
$downloadIsoBtn.Add_Click({
    try {
        ...
        $urlOutput = & $fidoPath -Win $script:SelectedWinVersion -Rel Latest -Ed Pro -Lang "English International" -Arch x64 -GetUrl
        ...
        Invoke-WebRequest -Uri $url -OutFile $saveDlg.FileName -UseBasicParsing
        $isoBox.Text = $saveDlg.FileName
        Write-Log "Download complete: $($saveDlg.FileName)"
        [System.Windows.Forms.MessageBox]::Show("Windows $($script:SelectedWinVersion) ISO downloaded and set as the build source (step 1).", "Download complete") | Out-Null
    }
    catch {
        Write-Log "ERROR: $($_.Exception.Message)"
...
$script:PostSetupBeforeLogin = New-Object System.Collections.ArrayList   # runs during specialize pass, SYSTEM context, before any user logs in
$script:PostSetupAfterLogin  = New-Object System.Collections.ArrayList   # runs as a first-logon command, after the user logs in

function New-PostSetupTab {
    param($TabControl, $Title, [System.Collections.ArrayList]$List)
    ...
    $nameLbl.Text = "Name:"; $nameLbl.Location = New-Object System.Drawing.Point(10, 170); $nameLbl.Size = New-Object System.Drawing.Size(50, 20)
    $tab.Controls.Add($nameLbl)
    $nameTb = New-Object System.Windows.Forms.TextBox
    $nameTb.Location = New-Object System.Drawing.Point(65, 168); $nameTb.Size = New-Object System.Drawing.Size(160, 22)
    $tab.Controls.Add($nameTb)

    $pathLbl = New-Object System.Windows.Forms.Label
    $pathLbl.Text = "Path/Cmd:"; $pathLbl.Location = New-Object System.Drawing.Point(10, 198); $pathLbl.Size = New-Object System.Drawing.Size(55, 20)
    $tab.Controls.Add($pathLbl)
    $pathTb = New-Object System.Windows.Forms.TextBox
    $pathTb.Location = New-Object System.Drawing.Point(65, 196); $pathTb.Size = New-Object System.Drawing.Size(300, 22)
    $tab.Controls.Add($pathTb)
    $pathBrowse = New-Object System.Windows.Forms.Button
    $pathBrowse.Text = "..."; $pathBrowse.Location = New-Object System.Drawing.Point(370, 195); $pathBrowse.Size = New-Object System.Drawing.Size(35, 24)
    $tab.Controls.Add($pathBrowse)
    $pathBrowse.Add_Click({
        $dlg = New-Object System.Windows.Forms.OpenFileDialog
        $dlg.Filter = "Installers (*.exe;*.msi;*.cmd;*.bat)|*.exe;*.msi;*.cmd;*.bat|All files (*.*)|*.*"
        if ($dlg.ShowDialog() -eq "OK") { $pathTb.Text = $dlg.FileName }
    })

    $argsLbl = New-Object System.Windows.Forms.Label
    $argsLbl.Text = "Arguments:"; $argsLbl.Location = New-Object System.Drawing.Point(10, 228); $argsLbl.Size = New-Object System.Drawing.Size(60, 20)
    $tab.Controls.Add($argsLbl)
    $argsTb = New-Object System.Windows.Forms.TextBox
    $argsTb.Location = New-Object System.Drawing.Point(65, 226); $argsTb.Size = New-Object System.Drawing.Size(300, 22)
    ...
    $passiveChk.Location = New-Object System.Drawing.Point(65, 254); $passiveChk.Size = New-Object System.Drawing.Size(150, 22)
    $tab.Controls.Add($passiveChk)

    $addBtn = New-Object System.Windows.Forms.Button
    $addBtn.Text = "Add"; $addBtn.Location = New-Object System.Drawing.Point(290, 252); $addBtn.Size = New-Object System.Drawing.Size(75, 26)
    $tab.Controls.Add($addBtn)

    $removeBtn = New-Object System.Windows.Forms.Button
    $removeBtn.Text = "Remove Selected"; $removeBtn.Location = New-Object System.Drawing.Point(10, 286); $removeBtn.Size = New-Object System.Drawing.Size(140, 26)
    $tab.Controls.Add($removeBtn)

    $addBtn.Add_Click({
        if (-not $nameTb.Text -or -not $pathTb.Text) {
            [System.Windows.Forms.MessageBox]::Show("Enter at least a Name and a Path/Command.", "Missing info") | Out-Null
            return
        }
        ...
        $entry = [PSCustomObject]@{ Name = $nameTb.Text; Path = $pathTb.Text; Arguments = $finalArgs }
        [void]$List.Add($entry)
        ...
        $lv.Items.Add($li) | Out-Null
        $nameTb.Text = ""; $pathTb.Text = ""; $argsTb.Text = ""
    })
...
function Show-PostSetupDialog {
    ...
    New-PostSetupTab -TabControl $tabs -Title "Before Login" -List $script:PostSetupBeforeLogin
    New-PostSetupTab -TabControl $tabs -Title "After Login" -List $script:PostSetupAfterLogin
    ...
    $saveBtn.Add_Click({
        ...
        $cfg = [PSCustomObject]@{
            BeforeLogin = @($script:PostSetupBeforeLogin)   # SYSTEM-context, runs before any user logs on (specialize pass)
            AfterLogin  = @($script:PostSetupAfterLogin)    # runs at first user logon (FirstLogonCommands)
        }
...
$postSetupBtn.Add_Click({ Show-PostSetupDialog })
...
function Show-UpdatesDialog {
    ...
    $folderLbl.Location = New-Object System.Drawing.Point(10, 10); $folderLbl.Size = New-Object System.Drawing.Size(200, 20)
    $dlg.Controls.Add($folderLbl)

    $folderTb = New-Object System.Windows.Forms.TextBox
    $folderTb.Text = $updatesBox.Text
    $folderTb.Location = New-Object System.Drawing.Point(10, 32); $folderTb.Size = New-Object System.Drawing.Size(340, 22)
    $dlg.Controls.Add($folderTb)

    $folderBrowse = New-Object System.Windows.Forms.Button
    $folderBrowse.Text = "Browse..."; $folderBrowse.Location = New-Object System.Drawing.Point(360, 31); $folderBrowse.Size = New-Object System.Drawing.Size(90, 24)
    $dlg.Controls.Add($folderBrowse)

    $fileList = New-Object System.Windows.Forms.ListBox
    $fileList.Location = New-Object System.Drawing.Point(10, 65); $fileList.Size = New-Object System.Drawing.Size(440, 210)
    $dlg.Controls.Add($fileList)

    function Update-FileList {
        $fileList.Items.Clear()
        if ($folderTb.Text -and (Test-Path $folderTb.Text)) {
            Get-ChildItem -Path $folderTb.Text -Include *.msu, *.cab -Recurse -ErrorAction SilentlyContinue |
                ForEach-Object { $fileList.Items.Add($_.Name) | Out-Null }
        }
    }
    Update-FileList
    ...
    $folderBrowse.Add_Click({
        ...
        if ($fbd.ShowDialog() -eq "OK") { $folderTb.Text = $fbd.SelectedPath; Update-FileList }
    })

    $addFilesBtn = New-Object System.Windows.Forms.Button
    $addFilesBtn.Text = "Add Update File(s)..."; $addFilesBtn.Location = New-Object System.Drawing.Point(10, 282); $addFilesBtn.Size = New-Object System.Drawing.Size(150, 28)
    $dlg.Controls.Add($addFilesBtn)

    $addFilesBtn.Add_Click({
        if (-not $folderTb.Text) {
            [System.Windows.Forms.MessageBox]::Show("Choose an updates folder first.", "No folder") | Out-Null
            return
        }
        New-Item -ItemType Directory -Path $folderTb.Text -Force | Out-Null
        $ofd = New-Object System.Windows.Forms.OpenFileDialog
        $ofd.Filter = "Update packages (*.msu;*.cab)|*.msu;*.cab"
        $ofd.Multiselect = $true
        if ($ofd.ShowDialog() -eq "OK") {
            foreach ($f in $ofd.FileNames) { Copy-Item -Path $f -Destination $folderTb.Text -Force }
            Update-FileList
        }
    })

    $removeFileBtn = New-Object System.Windows.Forms.Button
    $removeFileBtn.Text = "Remove Selected"; $removeFileBtn.Location = New-Object System.Drawing.Point(170, 282); $removeFileBtn.Size = New-Object System.Drawing.Size(130, 28)
    $dlg.Controls.Add($removeFileBtn)
    $removeFileBtn.Add_Click({
        if ($fileList.SelectedItem) {
            Remove-Item -Path (Join-Path $folderTb.Text $fileList.SelectedItem) -Force -ErrorAction SilentlyContinue
            Update-FileList
        }
    })

    $catalogBtn = New-Object System.Windows.Forms.Button
    $catalogBtn.Text = "Open Microsoft Update Catalog"; $catalogBtn.Location = New-Object System.Drawing.Point(10, 318); $catalogBtn.Size = New-Object System.Drawing.Size(220, 28)
    $dlg.Controls.Add($catalogBtn)
    $catalogBtn.Add_Click({ Start-Process "https://www.catalog.update.microsoft.com/Home.aspx" })

    $closeBtn = New-Object System.Windows.Forms.Button
    $closeBtn.Text = "Save && Close"; $closeBtn.Location = New-Object System.Drawing.Point(360, 318); $closeBtn.Size = New-Object System.Drawing.Size(90, 28)
...
$updatesMgrBtn.Add_Click({ Show-UpdatesDialog })
